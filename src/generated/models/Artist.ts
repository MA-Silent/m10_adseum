...
export type ArtistWhereInput = {
  ...
  uuid?: Prisma.StringFilter<"Artist"> | string
  name?: Prisma.StringFilter<"Artist"> | string
  description?: Prisma.StringFilter<"Artist"> | string
  shortDesc?: Prisma.StringFilter<"Artist"> | string
  images?: Prisma.StringNullableListFilter<"Artist">
}
...
export type ArtistCreateInput = {
  ...
  description: string
  shortDesc: string
  images?: Prisma.ArtistCreateimagesInput | string[]
}
...
export type ArtistUpdateInput = {
  ...
  images?: Prisma.ArtistUpdateimagesInput | string[]
}
...
export type ArtistCreateimagesInput = {
  set: string[]
}

export type ArtistUpdateimagesInput = {
  set?: string[]
  push?: string | string[]
}
...
export type ArtistOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"uuid" | "name" | "description" | "shortDesc" | "images", ExtArgs["result"]["artist"]>
...
export interface ArtistDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const artistWithUuidOnly = await prisma.artist.findMany({ select: { uuid: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Artists and only return the `uuid`
   * const artistWithUuidOnly = await prisma.artist.createManyAndReturn({
   *   select: { uuid: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Artists and only return the `uuid`
   * const artistWithUuidOnly = await prisma.artist.updateManyAndReturn({
   *   select: { uuid: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ArtistFieldRefs {
  readonly uuid: Prisma.FieldRef<"Artist", 'String'>
  readonly name: Prisma.FieldRef<"Artist", 'String'>
  readonly description: Prisma.FieldRef<"Artist", 'String'>
  readonly shortDesc: Prisma.FieldRef<"Artist", 'String'>
  readonly images: Prisma.FieldRef<"Artist", 'String[]'>
}
